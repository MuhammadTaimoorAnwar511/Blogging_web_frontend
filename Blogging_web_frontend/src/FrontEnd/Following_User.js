...
import followingIcon from '../FrontEnd/Pictures/people.png';
  ...
  useEffect(() => {
    ...
    const fetchUserBlogs = async (authorId) => {
      try {
        ...
        const response = await axios.get(`http://localhost:3000/api/userInteractions/feed`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
 ...
 return (
    <div>
      ...
      <nav className="navbar">
        <ul>
          ...
          {/* <li className="notification-icon">
            <a href="#">
              <img src={followingIcon} alt="Notifications" />
            </a>
          </li> */}
          <li>
      ...
      <div className="blog-list">
        ...
        min="1"
        max="10"
        value={ratings[blog._id] || ''}
        onChange={(e) => handleRatingChange(blog._id, e.target.value)}
        />
